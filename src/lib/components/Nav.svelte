...
<div class="flex flex-col h-screen">
  ...
  <!-- ── Header ─────────────────────────────────────────────────── -->
  <header class="flex items-center justify-between px-4 h-14 border-b border-gray-200 bg-white shrink-0">

    <!-- Logo (placeholder — swap src once asset is available) -->
    <div class="flex items-center gap-2">
      <div class="w-8 h-8 rounded-md bg-gray-200 flex items-center justify-center">
    ...
    >
      ...
      <!-- Chevron down -->
      <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  <div class="flex flex-1 overflow-hidden">
    ...
    <!-- Sidebar -->
    <aside class="w-56 flex flex-col border-r border-gray-200 bg-white shrink-0">
      ...
      <div class="px-2 py-3 border-t border-gray-200">
        ...
        >
          <!-- Gear icon -->
          <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
